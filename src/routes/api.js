...
API.put("/:username/profile", verifyToken, UserController.updateProfile);
...
API.put(
  "/post/:postId/replies/:commentId/by/:username",
  CommentController.replies_comment
);

API.put(
  "/post/:postId/on/:commentId/delete/:repId",
  CommentController.delete_rep_comment
);
